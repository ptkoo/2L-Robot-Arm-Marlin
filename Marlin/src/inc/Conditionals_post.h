 ...
 */
  ...
  #define ROBOT_ARM_2L_MAX_RADIUS (sqrt(sq(ROBOT_ARM_2L_LOW_SHANK)+sq(ROBOT_ARM_2L_HIGH_SHANK) - (2*ROBOT_ARM_2L_LOW_SHANK*ROBOT_ARM_2L_HIGH_SHANK*-0.984807753) ))//cos170°
#endif
/**
