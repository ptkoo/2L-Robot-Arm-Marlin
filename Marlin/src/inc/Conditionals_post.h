 ...
 */
  ...
  //#undef Z_SAFE_HOMING
  //#undef SLOWDOWN
  #define ROBOT_ARM_2L_Z_MAX (ROBOT_ARM_2L_LOW_SHANK + 50)
  #define ROBOT_ARM_2L_MIN_RADIUS (sqrt((sq(ROBOT_ARM_2L_LOW_SHANK) + sq(ROBOT_ARM_2L_HIGH_SHANK)) - (2*ROBOT_ARM_2L_LOW_SHANK*ROBOT_ARM_2L_HIGH_SHANK*ROBOT_ARM_2L_MIN_ANGLE_COS) ))
  #define ROBOT_ARM_2L_MAX_RADIUS (sqrt((sq(ROBOT_ARM_2L_LOW_SHANK) + sq(ROBOT_ARM_2L_HIGH_SHANK)) - (2*ROBOT_ARM_2L_LOW_SHANK*ROBOT_ARM_2L_HIGH_SHANK*ROBOT_ARM_2L_MAX_ANGLE_COS) ))
#endif
/**
